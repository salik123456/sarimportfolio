...
export default function AboutHero({ webinars }) {
  return (
    <div className="container px-8 md:px-4  text-black dark:text-white mx-auto max-w-2xl pt-36 flex  flex-col items-center justify-center">
      ...
      I have been using my designs to add a splash of color to the internet for the last 7+ years. I specialize in helping businesses to perfect their visual aesthetics, in order to make their products more attractive and user-friendly. Additionally, I am an active member of the {" "}
