...
import fai from "../images/faizan /Work/croods-1.png";
const Project = ({ p }) => {
  return (
    <a
      href={p.link}
    ...
    <div className="container mx-auto max-w-2xl p-4 text-black dark:text-white">
      {showHeading && (
        <div className=" flex items-center justify-between">
          <div className="text-[14px] font-bold opacity-60 tracking-[0.2em]">
            FEATURED PROJECTS
          </div>
          <a
            href="/work"
            className="bg-gradient-to-r bg-clip-text text-transparent from-[#1584EB] to-[#24D6D9]"
          >
            All Work
          </a>
        </div>
